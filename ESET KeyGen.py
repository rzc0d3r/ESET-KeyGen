...
# 1. Создать аккаунт через https://login.eset.com/Login (eset_intercepter)
# 2. Зайти в https://home.eset.com/licenses
# 3. Нажать на кнопку "Добавить лицензию" ("document.getElementsByClassName('ion-cui-button ios button button-solid ion-activatable ion-focusable hydrated')[1].click()")
# 4. Подождать, нажать на кнопку "Активировать пробную лицензию" ("document.getElementsByClassName('ion-cui-button ios button button-clear ion-activatable ion-focusable hydrated')[10].click()")
# 5. Мы попадаем в https://home.eset.com/protect/platform -> выбераем Windows ("document.getElementsByClassName('ion-cui-card device-protect-os-card ios hydrated')[1].click()")
# 6. Кликаем на "Продолжить" ("document.getElementsByClassName('ion-cui-button protect-page--continue-button ion-color ion-color-secondary ios button button-block button-solid ion-activatable ion-focusable hydrated')[0].click()")
# 7. Вводим почту в поле ("document.getElementsByClassName('sc-ion-input-ios-h sc-ion-input-ios-s ios hydrated')[0].value = "email...."")
# 8. Отправляем письмо на почту ("document.getElementsByClassName('ion-cui-button ios button button-solid ion-activatable ion-focusable hydrated')[2].click()")
# 9. Заходим в https://home.eset.com/licenses
# 10. Получаем ссылку на страницу полученой лицензии ("document.getElementsByClassName('ion-cui-button license-preview_link-btn ios button button-block button-solid ion-activatable ion-focusable hydrated')[0].href")
# 11. Заходим в эту лицензию ("window.open("https://home.eset.com"+ссылка на лицензию из 10 пункта)"")
# 12. Получаем тип лицензии ("document.getElementsByClassName('DetailInfoSectionItem__value')[0].textContent")
# 13. Получаем дату окончания действия лицензии ("document.getElementsByClassName('DetailInfoSectionItem__value')[2].textContent")
# 14. Получаем ключ лицензии ("document.getElementsByClassName('DetailInfoSectionItem__value')[4].textContent")